...
contract Ownable {
    ...
    modifier onlyOwner() {
      require(msg.sender == _owner, "Sorry, only owner can call this function");
      _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "The new address is empty address!");
...
contract Pausable is Ownable {
  ...
  modifier whenNotPaused() {
    require(_paused == false, "paused is false");
    _;
  }

  modifier paused() {
    require(_paused == true, "paused is true");
    _;
  }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != currentOwner, "The given address to not be the owner of the tokenId");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getOwner() || isApprovedForAll(currentOwner, (msg.sender)), "The address is not the owner or not approved address!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(from == ownerOf(tokenId), "the addres is not the owner of the token!");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    */
    ...
    /**
    * @dev Gets the base token url
    * @return string representing the base token url
    */
...
contract ERC721Mintable is ERC721Metadata("RandomName", "Ran", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
